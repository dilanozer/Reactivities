...
VALUES ('20241028112618_InitialCreate', '8.0.10');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241109145054_IdentityAdded', '8.0.10');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241110144834_ActivityAttendee', '8.0.10');

COMMIT;

BEGIN TRANSACTION;

ALTER TABLE "Activities" ADD "HostUsername" TEXT NULL;

ALTER TABLE "Activities" ADD "IsCancelled" INTEGER NOT NULL DEFAULT 0;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241110164326_AddCancelledProperty', '8.0.10');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241110174409_AddCancelledProperty2', '8.0.10');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241111154843_PhotoEntityAdded', '8.0.10');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241112145603_CommentEntityAdded', '8.0.10');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241113093230_FollowingEntityAdded', '8.0.10');
